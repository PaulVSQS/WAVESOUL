...
export function PlayerControls({ playerState, controls, isContemplative = false }: PlayerControlsProps) {
  ...
  return (
    ...
    >
      ...
      {/* Cargar otra canción */}
      <div className="change-audio-container" style={{ display: 'flex', alignItems: 'center' }}>
        <label htmlFor="change-audio-input" className="btn-volume" title="Cargar otra canción" style={{ cursor: 'pointer' }}>
